...
function update_name(){
	$.ajax({
		url:window.baseurl+"calendar/"+hash,
		type: "post",
		dataType: 'json',
...
function update_hashes(child_hash){
	...
	$.ajax({
		...
		success: function( result ){
			...
			$.ajax({
				url:window.baseurl+"calendar/"+child_hash,
				type: "post",
				dataType: 'json',
...
function get_all_master_data(output){
	...
	$.ajax({
		url:window.apiurl+"calendar/"+link_data.master_hash,
		type: "get",
		dataType: 'json',
		data: {},
		success: function(result){
...
function check_last_master_change(output){
	$.ajax({
		url:window.apiurl+"calendar/"+link_data.master_hash+"/last_changed",
		type: "post",
		dataType: 'json',
		data: {},
		success: function(result){
...
function get_all_data(output){
	...
	$.ajax({
		url:window.apiurl+"calendar/"+hash,
		type: "get",
		dataType: 'json',
		data: {},
		success: function(result){
...
function get_dynamic_data(output){
	...
	$.ajax({
		url:window.apiurl+"calendar/"+hash+"/dynamic_data",
		type: "get",
		dataType: 'json',
		data: {},
		success: function(result){
...
function check_last_change(output){
	$.ajax({
		url:window.apiurl+"calendar/"+hash+"/last_changed",
		type: "post",
		dataType: 'json',
		data: {},
		success: function(result){
...
function create_calendar(){
	...
	$.ajax({
		...
		success: function ( result ){
			localStorage.clear();
			window.location.href = window.baseurl+'calendar/'+result.hash+'/edit';
		},
		error: function ( log )
		{
			console.log(log);
