class ClockCanvas {
    ...
    get size() {
        return this.clock_face_canvas.parentElement.clientWidth - 20;
    }
    ...
    updateSize() {
        ...
        this.clock_face_canvas.width = size;
        this.clock_face_canvas.height = size;
        this.clock_sun_canvas.width = size;
        this.clock_sun_canvas.height = size;
        this.clock_background_canvas.width = size;
        this.clock_background_canvas.height = size;
        this.draw();
    }
