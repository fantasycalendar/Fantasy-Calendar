    ...
    <div class="bg-gray-900">
        <div class="relative pb-32 bg-gray-800">
            ...
            <div class="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
                ...
                <p class="mt-6 max-w-3xl text-xl text-gray-300">Timekeeping is the best tool you need to make your world feel like a living, breathing place where life happens around your players. With Fantasy Calendar, you're always ready for the question "How long has it been since...?"</p>
            </div>
        </div>
