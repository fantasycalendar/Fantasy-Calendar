                            ...
                            items: [
                                {
                                    ...
                                    callback: function() {
                                        window.dispatchEvent(new CustomEvent('event-editor-modal-new-event', { detail: { name: '', epoch: day.epoch } }));
                                    },
                                    disabled: function() {
                                        let disabled = !(Perms.player_at_least('player'));

                                        console.log('Item is disabled?', disabled);

                                        return disabled;
                                    },
                                    visible: function() {
                                        let visible = Perms.player_at_least('player');

                                        console.log('Item is visible?', visible);
