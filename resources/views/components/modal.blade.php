<div class="fixed z-10 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true" {{ $attributes->merge(['class' => 'absolute w-full h-full']) }} x-show="show" x-data="{ show: false }" x-cloak @modal="show = true;">
