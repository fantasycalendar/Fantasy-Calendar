<div class='col' x-data="{
    ...
    <div>
        <div class='row my-2'>
            <div class='col'>
                <input type='number' step="1.0" class='form-control small-input' x-model.debounce.500.number="year" {{ $attributes->whereStartsWith(':disabled') }}>
            </div>
        </div>
        ...
        <div class='row my-2'>
            <div class='col'>
                <select
                    type='number'
                    class='form-control'
                    x-model.debounce.500.number="_date.timespan"
        ...
        <div class='row my-2'>
            <div class='col'>
                <select type='number'
                    class='form-control'
                    x-model.debounce.500.number="_date.day"
                    {{ $attributes->whereStartsWith(':disabled') }}
                    >
