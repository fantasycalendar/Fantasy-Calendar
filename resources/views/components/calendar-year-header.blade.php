...
>
    ...
    <div class='flex-shrink-1 grid place-items-center px-1' x-show="!sidebar_open" x-cloak @click="$dispatch('open-sidebar')">
        <button class="btn btn-secondary !px-3 !text-xs !border-0"
