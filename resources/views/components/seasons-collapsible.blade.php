...
<div class='sortable list-group my-2' x-ref="seasons-sortable">
    <template x-for="(season, index) in seasons" x-ref="seasons-sortable-template" :key="season._id">
        <x-sortable-item item-key="season._id" deleteFunction="removeSeason(index)">
            <x-slot:inputs>
