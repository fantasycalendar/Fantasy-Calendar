			...
			<div x-show="data.advancement_enabled">
					...
					<div class="input-group-sm input-group">
						...
						<select class='custom-select form-control input-group-append'
							...
							<option :disabled='!clock_enabled' value='minutes'
											x-text="data.advancement_rate > 1 ? 'minutes' : 'minute'">minutes
							</option>
							<option :disabled='!clock_enabled' value='hours' x-text="data.advancement_rate > 1 ? 'hours' : 'hour'">
								hours
							</option>
				...
				<div class='row no-gutters'>
					<div class="col input-group">
						...
						@endfeature
						type='text' x-model="data.advancement_webhook_url" class='form-control form-control-sm input-group-append
						flex-grow-2' style="flex:2;" placeholder='http://my-web-hook.com/'>
						@feature('discord')
						<a target="_blank" x-show="data.advancement_webhook_format == 'discord'"
