...
<x-app-fullwidth-layout>
    <div>
        ...
        <section class="py-16" style="position: relative; overflow: hidden; background-color: rgb(44, 47, 51);">
            ...
            <div class="max-w-5xl mx-auto grid sm:grid-cols-2 py-5 z-20 relative gap-10">
                ...
                <div class="text-center md:text-right flex flex-col sm:flex-row items-center sm:justify-end">
        ...
        <section class="py-5" style="position: relative; overflow: hidden; background-color: rgb(44, 47, 51);">
            ...
            <div class="max-w-5xl m-auto py-5 grid grid-cols-2 z-20 relative gap-10">
        ...
        <section class="py-5 darkmode" style="background-color: #222222; background-image: url('{{ asset('resources/gray-square-bg.png') }}');">
            <div class="max-w-5xl m-auto py-5 grid sm:grid-cols-2 gap-10">
        ...
        <section class="py-5"  style="position: relative; overflow: hidden; background-color: rgb(44, 47, 51);">
            ...
            <div class="max-w-5xl m-auto py-5 grid sm:grid-cols-2 gap-10 text-white relative z-20">
                <div class="col-12 col-md-6 text-center md:text-left">
                ...
                <div class="col-12 col-md-6 text-center md:text-right flex flex-col md:items-end items-center justify-center">
        ...
        <section class="py-5" style="position: relative; overflow: hidden; background-color: #222222;">
            ...
            <div class="max-w-5xl mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8 relative z-20" style="max-width: 1300px;">
        ...
        <section class="py-3" style="background-color: #222222;">
            <div class="flex flex-col items-center py-10 space-y-4">
                ...
                @else
                <div><x-button-link role="custom" size="xl" class="text-white border-[color:#5865F2] dark:border-[color:#5865F2] bg-[#5865F2] dark:bg-[#5865F2] hover:bg-[color:#2f855a] dark:hover:border-[color:#2f855a] dark:hover:bg-[color:#2f855a] transition duration-100" :href='route("discord.index")'>Connect Your Account Now!</x-button-link></div>
                @endif
                <div><x-button-link size="md" :href='route("discord.server")'>Join Our Discord Server</x-button-link></div>
            </div>
        </section>

        <section class="bg-[#5865F2] text-center">
