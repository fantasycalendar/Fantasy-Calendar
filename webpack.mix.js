...
mix.copy(
    "resources/js/calendar/calendar_ajax_functions.js",
    "public/js/calendar"
);
...
mix.copy(
    "resources/js/calendar/calendar_weather_layout.js",
    "public/js/calendar"
);
mix.copy(
    "resources/js/calendar/calendar_day_data_layout.js",
    "public/js/calendar"
);
mix.copy(
    "resources/js/calendar/calendar_season_generator.js",
    "public/js/calendar"
);
mix.copy(
    "resources/js/calendar/calendar_inputs_visitor.js",
    "public/js/calendar"
);
...
mix.copy(
    "resources/js/webworkers/worker_event_tester.js",
    "public/js/webworkers"
);
