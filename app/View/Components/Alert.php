...
class Alert extends Component
{
    public array $styles = [
        ...
        'danger' => [
            'outerClasses' => 'bg-red-100 border-l-4 border-red-400 dark:border-red-600 dark:bg-red-900 p-4',
            'innerClasses' => 'text-sm text-red-700 dark:text-red-300',
            'iconClasses' => 'fa fa-times-circle text-red-400 dark:text-red-300',
            'icon' => 'fa times-circle',
        ],
        'success' => [
            'outerClasses' => 'bg-green-100 border-l-4 border-green-400 dark:border-green-600 dark:bg-green-900 p-4',
