...
class Button extends Component
{
    ...
    public array $roleSpecific = [
        'primary' => 'text-white bg-primary-600 hover:bg-primary-700 dark:bg-primary-900 dark:hover:bg-primary-800 focus:ring-primary-500 border-transparent',
        ...
        'danger' => 'text-white bg-red-600 hover:bg-red-700 dark:bg-red-900 dark:hover:bg-red-800 focus:ring-red-500 border-transparent',
    ];
