...
class CalendarController extends Controller
{
    ...
    public function update(Request $request, Calendar $calendar)
    {
        ...
        if (array_key_exists('advancement', $update_data)) {
            ...
            $unitMethod = 'add' . ucfirst($update_data['advancement_real_rate_unit']);
            $rate = $update_data['advancement_real_rate'];

            $update_data['advancement_next_due'] = now()->$unitMethod($rate);
