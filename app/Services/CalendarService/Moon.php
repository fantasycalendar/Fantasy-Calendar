...
class Moon
{
    ...
    public const GRANULARITY_4 = [
        0, 12, 24, 36
    ];

    public const GRANULARITY_8 = [
        0,
        6,
        12,
        18,
    ...
    public static function pathIndexForPhase($phase, $granularity)
    {
        return match($granularity) {
            4 => self::GRANULARITY_4[$phase],
            8 => self::GRANULARITY_8[$phase],
            16 => self::GRANULARITY_16[$phase],
            24 => self::GRANULARITY_24[$phase],
            default => $phase,
        };
    }
}
