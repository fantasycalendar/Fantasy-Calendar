...
<html lang="en">
	...
	<head>
		...
		window.baseurl = '<?php echo getenv('WEBADDRESS'); ?>';
	...
	<body>
		...
		<header id="header">
			...
			<div id="header_left_container">
				...
				<a href="/calendars/create"><div class="button" id="new_calendar">New Calendar</div></a>
			</div>
		...
		<div id="content">
			<div id="loading_background" class='basic-background hidden'>
				<img src='resources/icons/loader_white.png'>
