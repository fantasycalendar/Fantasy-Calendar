...
if(isset($_SESSION['beta']) && $_SESSION['beta'] == 1){

	redirect('https://beta.fantasy-calendar.com/', 303);

}else{

	header('Cache-Control: no-cache');

	$title = "Beta permissions not found";
	...
	<div class="site">
		...
		<h1><small>Your account is not BETA activated, sorry</small></h1>
	</div>
